function NoGames() {
  return (
    <div className="px-0.5 w-full">
      <div className="p-2 w-full rounded border-b-amber-400 text-amber-800 bg-amber-400/30 ring-2 ring-offset-2 ring-amber-200 text-sm md:text-base text-center">
